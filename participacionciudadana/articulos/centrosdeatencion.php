...
<head>
    ...
    <body>
                                ...
                                <div class="container-fluid ">
                                    ...
                                    <div class="collapse navbar-collapse justify-content-center" id="navbarCenteredExample">
                                        ...
                                        <ul id="nav" class="sf-js-enabled" style="padding: 16px 0;">
                                            ...
                                            <li id="navTab04">
                                                <a class="mainNavItem" href="./">Participación Ciudadana</a>
                                            </li>
                                            <!--
                                            <li id="navTab04">
            ...
            <!-- Artículo -->
            <!-- Añadir dentro de tu <body> justo después de tu código de header -->
            <section id="article-section" class="container my-5">
                
                <!-- Título centrado y en grande -->
                
                    <div class="col-12 text-center">
                        <div class="text-center articulo-header">Centros de atención ciudadana</div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <img src="https://www.bajacalifornia.gob.mx/Recursos/Imagenes/Bienestar/Centros.jpg" class="img-fluid" alt="Banner del artículo">
                    </div>
                </div>

                <!-- Contenido del artículo -->
                <div class="row my-5">
                    <!-- Primera columna: contenido principal del artículo (70%) -->
                    <div class="col-lg-8">
                        <!-- Sección Principal del Proyecto -->
                        <h1>Encabezado del artículo</h1>
                        <p>Este es el primer párrafo del artículo.</p>
                        <p>Este es otro párrafo del artículo.</p>
                        <!-- ... -->

                        <!-- Sección Principal del Proyecto -->
                        <h1>Proyecto Tarjeta Violeta en Baja California</h1>
                        <p>La Tarjeta Violeta es una iniciativa innovadora del gobierno de Baja California para empoderar a las mujeres en la región. Este proyecto tiene como objetivo proporcionar recursos y apoyo a mujeres que han sido víctimas de violencia de género.</p>
                        <p>El proyecto se enfoca en brindar servicios médicos, asesoramiento legal, refugio seguro y capacitación laboral para que las mujeres puedan reconstruir sus vidas de manera segura y exitosa.</p>
                        <!-- Puedes continuar agregando más contenido principal según sea necesario -->

                    </div>

                    <!-- Segunda columna: barra lateral o contenido secundario (30%) -->
                    <div class="col-lg-4">
                        <!-- Sección Secundaria del Proyecto -->
                        <h2>Contenido secundario</h2>
                        <p>Este es el contenido que irá en la barra lateral.</p>

                        <!-- Sección Secundaria del Proyecto -->
                        <h2>Beneficios de la Tarjeta Violeta</h2>
                        <p>La Tarjeta Violeta ofrece una serie de beneficios, que incluyen:</p>
                        <ul>
                        <li>Acceso a atención médica de calidad.</li>
                        <li>Asesoramiento legal y apoyo emocional.</li>
                        <li>Oportunidades de capacitación y empleo.</li>
                        <li>Refugio seguro para mujeres en riesgo.</li>
                        </ul>
                        <p>Además, este proyecto busca crear conciencia sobre la violencia de género y promover la igualdad de género en la sociedad.</p>
