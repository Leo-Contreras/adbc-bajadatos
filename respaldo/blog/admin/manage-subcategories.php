...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['resid']) {
        ...
        $msg = "Subcategoria restablecida con exito";
    }
    // Code for Forever deletionparmdel
    if ($_GET['action'] == 'perdel' && $_GET['scid']) {
        $id = intval($_GET['scid']);
        $query = mysqli_query($con, "delete from   tblsubcategory  where SubCategoryId='$id'");
        $delmsg = "Subcategoria eliminada permanentemente";
    }
?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <title> Gobierno Abierto | Administrar SubCategorias</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Administrar SubCategorias</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="demo-box m-t-20">
                                        <div class="m-b-30">
                                            <h4><i class="fa fa-trash-o"></i> SubCategorias eliminadas</h4>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table m-0 table-colored-bordered table-bordered-danger">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td colspan="7" align="center">
                                                                <h3 style="color:red">No hay registro</h3>
                                                            </td>
                                                        <tr>
                                                            <?php
                                                        } else {
