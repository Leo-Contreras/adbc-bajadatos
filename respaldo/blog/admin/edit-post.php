...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "update tblposts set PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',Summary='$summary',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$postid'");
        if ($query) {
...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Gobierno Abierto | Editar publicación</title>
        <!-- Summernote css -->
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <?php
                        $postid = intval($_GET['pid']);
                        $query = mysqli_query($con, "select tblposts.id as postid,tblposts.PostImage,tblposts.PostTitle as title,tblposts.Summary,tblposts.PostDetails,tblcategory.CategoryName as category,tblcategory.id as catid,tblsubcategory.SubCategoryId as subcatid,tblsubcategory.Subcategory as subcategory from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.id='$postid' and tblposts.Is_Active=1 ");
                                        ...
                                        <div class="">
                                            <form name="addpost" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>Resumen</b></h4>
                                                            <input class="form-control" name="summary" value="<?php echo htmlentities($row['Summary']); ?>" maxlength="130" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>Imagen a publicar</b></h4>
