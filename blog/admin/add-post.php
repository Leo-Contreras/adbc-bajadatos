    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            if (move_uploaded_file($_FILES["postimage"]["tmp_name"], "postimages/" . $imgnewfile)) {
                $status = 1;
                $query = mysqli_query($con, "insert into tblposts(PostTitle,CategoryId,SubCategoryId,Summary,PostDetails,Is_Active,PostUrl,PostImage) values('$posttitle','$catid','$subcatid','$summary','$postdetails','$status','$url','$imgnewfile')");
                $e = mysqli_errno($con);
                if ($query) {
...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Gobierno Abierto | Agregar publicación</title>
        <!-- Summernote css -->
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        ...
                                                        <input class="form-control" name="summary" maxlength="130" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
