		...
		<div class="col-md-12 col-lg-12">
			<div class="centrar">
				<div class="ContenidoTexto">
					<label class="ContenidoTitulo">Transparencia Proactiva</label>
	...
	<div class="pnlInformacionFrecuente">
		<div class="col-md-12 col-lg-12">
			<div class="center" style="padding-top: 2%;">
				<dt class="etiquetaInformacionFrecuente">SOLICITUDES DE INFORMACIÓN FRECUENTES</dt>
			</div>
			<div class="carouselInformacionFrecuente">
				<div class="carouselInformacionF">
					<div class="carouselInformacionF-container">
						<div class="cardInformacionF">
							<div class="contenidoCarouselInformacionF">
								<div>
									<label>Ejercicio del gasto publico</label>
									<div></div>
									<label>ADMICARGA</label>
									<label>Administración de la Vía Corta de Tijuana-Tecate</label>
								</div>
							</div>
						</div>
						<div class="cardInformacionF">
