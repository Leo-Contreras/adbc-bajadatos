...
<div class="header-background">
	...
	<div class="EncabezadoGobierno ">
		<div class="col-md-12 col-lg-12">
					<label class="ContenidoTitulo">¿Qué es la Transparencia Proactiva?</label>
					<br>
					<label class="ContenidoSubTitulo">La Transparencia Proactiva, en su sentido más amplio, implica poner a disposición de un grupo concreto de la población información sobre un tema específico que sea de su interés (educación, salud, transporte, seguridad, servicios, trámites, u otro) con la finalidad de generar conocimiento para un fin concreto; y, es precisamente por esta razón, que en un esquema de Transparencia Proactiva la oferta de información de una institución debe ser definida a partir de las propias necesidades y hábitos de consulta y consumo de información de las personas destinatarias a las que busca dirigirse. (SFP-INAI) </label>
...
<!-- Sección 2: ¿Qué beneficios busca? -->
<div class="EncabezadoGobierno ">
	<label class="ContenidoTitulo  pt-5 mt-5 pb-5">¿Qué beneficios busca?</label>
...
<div class="EncabezadoGobierno">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <i class="fa fa-check-circle mr-2" style="color: green;"></i>Accesible
                        </div>
                    </div>
                </div>
    ...
    <!-- Columna Derecha: Imagen -->
		<div class="col-lg-6 col-md-12">
			<div class="card h-100">
				<img src="assets/img/estrellas.png" alt="Descripción de la imagen" class="card-img-top mx-auto" style="max-width: 400px; max-height: 400px;">
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 mb-3">
				<div class="card h-100 custom-card"> <!-- Agregamos la clase "custom-card" aquí -->
					<div class="card-body">
			...
			<!-- Lineamientos para la Emisión y Evaluación -->
			<div class="col-lg-6 col-md-6 mb-3">
				<div class="card h-100 custom-card"> <!-- Agregamos la clase "custom-card" aquí -->
					<div class="card-body">
